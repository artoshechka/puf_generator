...
/// @brief Число раундов голосования большинством по умолчанию для MajorityVoter.
///
/// Должно быть нечётным для однозначного большинства. 3 раунда — оптимальный
/// баланс стабильности и скорости для большинства конфигураций RO PUF.
