...
void printRawCounts()
{
    puf::RoOscillator oscs[kOscCount] = {
        puf::RoOscillator(0U),  puf::RoOscillator(1U),  puf::RoOscillator(2U),
        puf::RoOscillator(3U),  puf::RoOscillator(4U),  puf::RoOscillator(5U),
        puf::RoOscillator(6U),  puf::RoOscillator(7U),  puf::RoOscillator(8U),
        puf::RoOscillator(9U),  puf::RoOscillator(10U), puf::RoOscillator(11U),
        puf::RoOscillator(12U), puf::RoOscillator(13U), puf::RoOscillator(14U),
        puf::RoOscillator(15U), puf::RoOscillator(16U), puf::RoOscillator(17U),
        puf::RoOscillator(18U), puf::RoOscillator(19U), puf::RoOscillator(20U),
        puf::RoOscillator(21U), puf::RoOscillator(22U), puf::RoOscillator(23U),
        puf::RoOscillator(24U), puf::RoOscillator(25U), puf::RoOscillator(26U),
        puf::RoOscillator(27U), puf::RoOscillator(28U), puf::RoOscillator(29U),
        puf::RoOscillator(30U), puf::RoOscillator(31U),
    };
